...
public class PDF2MultipageColorTiff {
    public static void main(String[] args) {
        ...
        try {
            ...
            settings.setRenderingSurface(new PDFRgbByteBlockRenderingSurface());
            ...
            System.out.println("PDF2MultipageColorTiff sample completed.");
        }
