...
public class PDF2GrayImage {
    public static void main(String[] args) {
        ...
        try {
            ...
            settings.setRenderingSurface(pageRenderer.createRenderingSurface(PDFRenderingSurfaceType.GRAY_8_BLOCK, settings.getDpiX(), settings.getDpiY()));
            ...
            System.out.println("PDF2GrayImage sample completed.");
        }
