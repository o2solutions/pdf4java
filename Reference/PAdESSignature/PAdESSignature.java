...
import com.o2sol.pdf4java.document.PDFVersion;
import com.o2sol.pdf4java.document.PDFVersionExtension;
...
public class PAdESSignature {
    public static void main(String[] args) throws IOException, java.security.KeyStoreException, java.security.NoSuchProviderException, java.security.NoSuchAlgorithmException, java.security.cert.CertificateException, java.security.UnrecoverableKeyException {
        ...
        try {
            ...
            document.setPDFVersion(PDFVersion.VERSION_1_7);
            document.setVersionExtension(new PDFVersionExtension("/ESIC", 2, PDFVersion.VERSION_1_7));
            ...
            signature.setReason("PAdES signature");
            signField.setSignature(signature);

            document.save("PAdESSignature.pdf");
