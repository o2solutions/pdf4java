...
CD DocumentIncrementalUpdate
CALL run.bat
CD ..
 
CD DocumentPageByPageSave
CALL run.bat
CD ..
    
CD DocumentProperties
CALL run.bat
CD ..
...
CD GrayscaleConversion
CALL run.bat
CD ..
       
CD HeadersAndFooters
CALL run.bat
CD ..
